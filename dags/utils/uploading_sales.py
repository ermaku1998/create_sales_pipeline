...
def delete_from_pmix_sales_hist():
    with postgre_engine.connect() as con:
        rs = con.execute('''
...
def create_assort_prhist_last40():
    with postgre_engine.connect() as con:
        rs = con.execute('''
